...
- What story should the page tell first, second, and third?
...
4. Define the narrative hierarchy.
5. Write the page spec in a way that is not tied to one tool.
6. Pick the information design patterns.
7. Check the spec against Decision Support QA.
8. Hand the approved spec to the Power BI builder.
9. Inspect the existing PBIP report and Power BI model.
10. Reuse approved page and visual patterns.
11. Build the bindings, layout, interactions, and theme.
12. Run automated PBIP checks.
13. Do the final Power BI Desktop inspection.

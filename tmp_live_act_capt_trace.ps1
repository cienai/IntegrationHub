...
$resultFile = Join-Path $root 'tmp_live_act_capt_trace.csv'
...
CALCULATETABLE(
    ROW(
        ...
        "Raw Factor", [meas.ai_scores_ci_act_capt_lvl_factor1_value],
        "Direct Score", [meas.ai_scores_ci_act_capt_lvl],
        "Wrapped Score", [meas.ai_score],
        "Factor1 Helper", [meas.ai_scores_factor1_value]
    ),
    metadata_ai_scores[score_name] = "Activity Capture Level",
    __DATE_FILTER__
)
"@
